...
config = {
    ...
    "Booter": {"MmioWhitelist": [], "Patch": [], "Quirks": {
        "AllowRelocationBlock": False, "AvoidRuntimeDefrag": False,
        ...
        "ForceBooterSignature": True, "ForceExitBootServices": False,
        "ProtectMemoryRegions": False, "ProtectSecureBoot": True,
        "ProtectUefiServices": False, "ProvideCustomSlide": False,
        "ProvideMaxSlide": 0, "RebuildAppleMemoryMap": False,
        "ResizeAppleGpuBars": -1, "SetupVirtualMap": False,
        "SignalAppleOS": False, "SyncRuntimePermissions": False,
    }},
    ...
    "Misc": {
        ...
        "Boot": {
            ...
            "LauncherPath": "Default", "PickerAttributes": 145,
